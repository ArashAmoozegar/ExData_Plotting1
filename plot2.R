...
# Creating Plot 2 and saving to a PNG file with a width of 480 pixels and a height of 480 pixels.
png("plot2.png", width = 480, height = 480)
plot(Date_Time_Combination, as.numeric(power_dataset_sub1$Global_active_power), ylab = "Global Active Power (kilowats)", type = "l", xlab = "")
dev.off()